    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('home', 'HOME', 'Dashboard');
        ?>
        <!-- header section end -->
        <div class="ph">
        <img src="images/pharm.jpg" style="cursor:pointer;width:70.5%">
        <iframe src="https://www.worldometers.info/coronavirus/" title="COVID-WORLDOMETER" frameBorder="0" style="position:relative;top:0%;height: 520px; width: 360px; vertical-align:top;";></iframe>  
        </div>
